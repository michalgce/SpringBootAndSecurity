...
import pl.majkel.controllers.ApiController;
import pl.majkel.dtos.security.TokenResponseDto;
...
public class AuthenticationFilter extends GenericFilterBean {
    ...
    private void processUsernamePasswordAuthentication(HttpServletResponse httpResponse, Optional<String> username, Optional<String> password) throws IOException {
        ...
        TokenResponseDto tokenResponse = new TokenResponseDto(resultOfAuthentication.getDetails().toString());
